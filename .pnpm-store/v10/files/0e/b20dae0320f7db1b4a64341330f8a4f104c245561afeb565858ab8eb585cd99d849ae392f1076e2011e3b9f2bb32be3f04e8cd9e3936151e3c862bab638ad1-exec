...
const ponder = new Command("ponder")
    ...
    .option("--log-level <LEVEL>", 'Minimum log level ("error", "warn", "info", "debug", or "trace", default: "info")')
...
const devCommand = new Command("dev")
    ...
    .option("-H, --hostname <HOSTNAME>", 'Hostname for the web server (default: "0.0.0.0" or "::")')
